...
export function Component() {
  ...
  return (
    <>
      <Button
        className="relative float-right size-32 rounded-full bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300  text-white  text-lg px-5 py-2.5 text-center me-2 mb-2 dark:focus:ring-yellow-900"
